...
## 2.2.2 Navigate to the `ONT` directory and activate the `assembly_ont` environment
Before we start, navigate into the `ONT/` directory and activate the `assembly_ont` environment:
...
Finally, deactivate the `assembly_ont` environment:
